...
nTh:null,nTf:null,sClass:null,sContentPadding:null,sDefaultContent:null,sName:null,sSortDataType:"std",sSortingClass:null,sSortingClassJUI:null,sTitle:null,sType:null,sWidth:null,sWidthOrig:null};o.defaults={aaData:null,aaSorting:[[0,"asc"]],aaSortingFixed:[],ajax:null,aLengthMenu:[10,15,30,50,100],aoColumns:null,aoColumnDefs:null,aoSearchCols:[],asStripeClasses:null,bAutoWidth:!0,bDeferRender:!1,bDestroy:!1,bFilter:!0,bInfo:!0,bJQueryUI:!1,bLengthChange:!0,bPaginate:!0,bProcessing:!1,bRetrieve:!1,bScrollCollapse:!1,
...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"Вперед",sPrevious:"Назад"},sEmptyTable:"Данные отсутствуют в таблице",sInfo:"Показаны с <b>_START_ по _END_</b> из _TOTAL_ записей",sInfoEmpty:"",sInfoFiltered:"",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показывать по _MENU_",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"",sSearchPlaceholder:"Поиск",sUrl:"",sZeroRecords:"Не найдено ни одной записи"},oSearch:h.extend({},
...
sPageButtonDisabled:"disabled",sStripeOdd:"odd",sStripeEven:"even",sRowEmpty:"dataTables_empty",sWrapper:"dataTables_wrapper",sFilter:"dataTables_filter",sInfo:"dataTables_info",sPaging:"dataTables_paginate",sLength:"dataTables_length",sProcessing:"dataTables_processing",sSortAsc:"sorting_asc",sSortDesc:"sorting_desc",sSortable:"sorting",sSortableAsc:"sorting_asc_disabled",sSortableDesc:"sorting_desc_disabled",sSortableNone:"sorting_disabled",sSortColumn:"sorting_",sFilterInput:"",sLengthSelect:"",
...
$.extend(true, $.fn.dataTable.defaults, {
    "sDom": "<'row-fluid data-header'<'col-ph-6'l><'col-ph-6'f>r>t<'row-fluid table-footer'<'col-ph-12'p i>>",
...
$.extend($.fn.dataTableExt.oPagination, {
    "bootstrap": {
        "fnInit": function(oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).addClass('clr').append('<ul>' + '<li class="prev disabled"><a href="#"><i class="fa fa-chevron-left"></i></a></li>' + '<li class="next disabled"><a href="#"><i class="fa fa-chevron-right"></i></a></li>' + '</ul>');
            var els = $('a', nPaging);
            $(els[0]).bind('click.DT', {
                action: "previous"
            }, fnClickHandler);
