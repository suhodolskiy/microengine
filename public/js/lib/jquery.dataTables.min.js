...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"Вперед",sPrevious:"Назад"},sEmptyTable:"No data available in table",sInfo:"Показаны с <b>_START_ по _END_</b> из _TOTAL_ записей",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показывать по _MENU_",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"",sSearchPlaceholder:"Поиск",sUrl:"",sZeroRecords:"Не найдено ни одной записи"},oSearch:h.extend({},
